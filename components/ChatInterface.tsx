...
export function ChatInterface() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm your AI wardrobe assistant. Tell me about an upcoming event and I'll recommend outfits from your wardrobe!",
    },
  ])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const assistantMessage: Message = {
        role: 'assistant',
        content: data.recommendations?.length > 0
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Get Outfit Recommendations</h2>
